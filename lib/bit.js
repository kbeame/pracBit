...
console.log(bitmap);
console.log('bitmap blue ' + bitmap.readUInt8(96));
console.log('bitmap green ' + bitmap.readUInt8(97));
console.log('bitmap red ' + bitmap.readUInt8(98));
console.log('bitmap alpha ' + bitmap.readUInt8(99));
...
console.log('new bitmap blue ' + i + NEWbitmap.readUInt8(i));
console.log('new bitmap green ' + (i+1) + NEWbitmap.readUInt8(i + 1));
console.log('new bitmap red ' + (i+2) + NEWbitmap.readUInt8(i + 2));
console.log('new bitmap alpha ' + (i+3) + NEWbitmap.readUInt8(i +3));
